...
-- Remote required for awesome-client
...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/pbr/theme.lua")
...
batterywidget = lain.widgets.bat({
  settings = function()
    ...
    if bat_now.status == "Discharging" then
      bat_markup = markup.urgent(" " .. bat_header .. bat_p .. bat_now.status .. " " .. bat_now.watt .. " " .. bat_now.time .. " ")
    else
      bat_markup = markup.normal(" " .. bat_header .. bat_p .. bat_now.status .. " ")
    end
